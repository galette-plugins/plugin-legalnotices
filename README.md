...
[![GitHub license](https://img.shields.io/github/license/galette-plugins/plugin-legalnotices
)](https://github.com/galette-plugins/plugin-legalnotices/blob/master/COPYING)
...
* [website](https://galette-plugins.github.io/plugin-legalnotices/)
* [bugs and features](https://github.com/galette-plugins/plugin-legalnotices/issues)
...
* download latest stable version from the [Galette Legal Notices plugin page](https://galette-plugins.github.io/plugin-legalnotices/)
* use [Galette Legal Notices plugin source code from repository](https://github.com/galette-plugins/plugin-legalnotices/) (make sure you install the third-party dependencies), this solution requires some technical skills
...
* [site web](https://galette-plugins.github.io/plugin-legalnotices/)
